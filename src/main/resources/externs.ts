...
// Export date: 2024-07-20T17:46:10.510582274Z
// -----------------------------------------------------------------------------
...
export const core = {
   ...
   file_path_unsafe_debug_last_modified(self: Ref): Ref { return impl.file_path_unsafe_debug_last_modified(self); },
   //
   ...
   // -------------------------------------------------------------------------
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:90)
