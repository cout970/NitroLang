...
// Export date: 2023-12-09T01:00:05.311409812Z
// -----------------------------------------------------------------------------
...
export const core = {
   ...
   // -------------------------------------------------------------------------
   //
   // At src/main/nitro/core/lang/intrinsic.nitro(intrinsic.nitro:10)
   ...
   //
   // At src/main/nitro/core/lang/intrinsic.nitro(intrinsic.nitro:15)
   ...
   // -------------------------------------------------------------------------
   //
   // At src/main/nitro/core/primitives/float.nitro(float.nitro:32)
   ...
   //
   // At src/main/nitro/core/primitives/float.nitro(float.nitro:127)
   // @Extern [lib="core", name="float_is_nan"]
   // fun is_nan(Float): Boolean
   float_is_nan(self: Float): Boolean { return impl.float_is_nan(self); },
   //
   // At src/main/nitro/core/primitives/float.nitro(float.nitro:131)
   ...
   //
   // At src/main/nitro/core/primitives/float.nitro(float.nitro:138)
   ...
   //
   // At src/main/nitro/core/primitives/float.nitro(float.nitro:146)
   ...
   //
   // At src/main/nitro/core/primitives/float.nitro(float.nitro:157)
   ...
   //
   // At src/main/nitro/core/memory/intrinsic_memory.nitro(intrinsic_memory.nitro:16)
   ...
   //
   // At src/main/nitro/core/memory/intrinsic_memory.nitro(intrinsic_memory.nitro:20)
   ...
   // -------------------------------------------------------------------------
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:33)
   ...
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:37)
   ...
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:41)
   ...
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:45)
   ...
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:49)
   ...
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:53)
   ...
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:57)
   ...
   //
   // At src/main/nitro/core/memory/memory_arena.nitro(memory_arena.nitro:61)
   ...
   // -------------------------------------------------------------------------
   //
   // At src/main/nitro/core/sorting/ordering.nitro(ordering.nitro:58)
   ...
   //
   // At src/main/nitro/core/string/string.nitro(string.nitro:60)
   ...
   //
   // At src/main/nitro/core/string/string.nitro(string.nitro:64)
   ...
   //
   // At src/main/nitro/core/string/string.nitro(string.nitro:79)
   ...
   //
   // At src/main/nitro/core/string/string.nitro(string.nitro:83)
   ...
   //
   // At src/main/nitro/core/string/string.nitro(string.nitro:252)
   ...
   //
   // At src/main/nitro/core/string/string.nitro(string.nitro:256)
   ...
   // -------------------------------------------------------------------------
   //
   // At src/main/nitro/core/time/instant.nitro(instant.nitro:16)
   // @Extern [lib="core", name="instant_now"]
   // fun Instant::now(): Instant
   instant_now(): Ref { return impl.instant_now(); },
   //
   // At src/main/nitro/core/time/instant.nitro(instant.nitro:19)
   ...
   // -------------------------------------------------------------------------
   //
   // At src/main/nitro/core/debug/check.nitro(check.nitro:11)
