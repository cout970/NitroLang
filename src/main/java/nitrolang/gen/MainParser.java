...
public class MainParser extends Parser {
	...
	public static final int
		...
		XORXOR=13, COMPARE=14, EQ=15, NEQ=16, LEQ=17, GEQ=18, BANGBANG=19, DOT=20, 
		LPAREN=21, RPAREN=22, LBRACE=23, LBRACKET=24, RBRACKET=25, COMMA=26, COLON=27, 
		ADD=28, SUB=29, MUL=30, DIV=31, XOR=32, DOLAR=33, MOD=34, AT=35, HASH=36, 
		OR=37, AND=38, NOT=39, ASSIGN=40, LTH=41, GTH=42, THIS=43, THIS_TYPE=44, 
		FUN=45, LET=46, MODULE=47, STRUCT=48, RETURN=49, SIZE_OF=50, OPTION=51, 
		REC=52, TAG=53, NOTHING=54, WHEN=55, MATCH=56, EITHER=57, ALIAS=58, IF=59, 
		ELSE=60, FOR=61, IN=62, NOT_IN=63, WHILE=64, REPEAT=65, LOOP=66, IS=67, 
		NOT_IS=68, AS=69, TRUE=70, FALSE=71, NULL=72, INCLUDE=73, BREAK=74, CONTINUE=75, 
		JSON=76, USE=77, MUT=78, REF=79, REF_MUT=80, COPY=81, BLOCK_START=82, 
		WHITE_SPACE=83, NL=84, DOC_COMMENT=85, BLOCK_COMMENT=86, INT_NUMBER=87, 
		FLOAT_NUMBER=88, IDENTIFIER=89, PLAIN_STRING=90, STRING_START=91, RBRACE=92, 
		ERROR_CHARACTER=93, STRING_ESCAPE=94, STRING_INTERP_START=95, STRING_INTERP_END=96, 
		STRING_VAR=97, STRING_BLOB=98, STRING_END=99, BLOCK_END=100, BLOCK_BLOB=101, 
		BLOCK_OTHER=102;
	public static final int
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			null, null, null, null, "'nothing'", "'when'", "'match'", "'either'", 
			"'alias'", "'if'", "'else'", "'for'", "'in'", "'!in'", "'while'", "'repeat'", 
			"'loop'", "'is'", "'!is'", "'as'", "'true'", "'false'", "'null'", "'include'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"DOT", "LPAREN", "RPAREN", "LBRACE", "LBRACKET", "RBRACKET", "COMMA", 
			"COLON", "ADD", "SUB", "MUL", "DIV", "XOR", "DOLAR", "MOD", "AT", "HASH", 
			"OR", "AND", "NOT", "ASSIGN", "LTH", "GTH", "THIS", "THIS_TYPE", "FUN", 
			"LET", "MODULE", "STRUCT", "RETURN", "SIZE_OF", "OPTION", "REC", "TAG", 
			"NOTHING", "WHEN", "MATCH", "EITHER", "ALIAS", "IF", "ELSE", "FOR", "IN", 
			"NOT_IN", "WHILE", "REPEAT", "LOOP", "IS", "NOT_IS", "AS", "TRUE", "FALSE", 
			"NULL", "INCLUDE", "BREAK", "CONTINUE", "JSON", "USE", "MUT", "REF", 
			"REF_MUT", "COPY", "BLOCK_START", "WHITE_SPACE", "NL", "DOC_COMMENT", 
			"BLOCK_COMMENT", "INT_NUMBER", "FLOAT_NUMBER", "IDENTIFIER", "PLAIN_STRING", 
			"STRING_START", "RBRACE", "ERROR_CHARACTER", "STRING_ESCAPE", "STRING_INTERP_START", 
	...
	public final ParseFileContext parseFile() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while (((((_la - 35)) & ~0x3f) == 0 && ((1L << (_la - 35)) & 4672933149697L) != 0)) {
				{
				{
				setState(230);
				definition();
	...
	public final StringContext string() throws RecognitionException {
		...
		try {
			...
			case STRING_START:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while (((((_la - 94)) & ~0x3f) == 0 && ((1L << (_la - 94)) & 27L) != 0)) {
					{
					{
					setState(277);
					stringContents();
	...
	public final ConstExpressionLiteralContext constExpressionLiteral() throws RecognitionException {
		...
		try {
			...
			setState(1203);
			_la = _input.LA(1);
			if ( !(((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 1441799L) != 0)) ) {
			_errHandler.recoverInline(this);
			}
			else {
				if ( _input.LA(1)==Token.EOF ) matchedEOF = true;
	...
	public final WhenExprContext whenExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 632202144348373112L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 4063351L) != 0)) {
				{
				setState(1212);
				expression();
				}
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1785123648955220088L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 4063351L) != 0)) {
				{
				setState(1228);
				whenEntry();
				setState(1234);
	...
	public final MapExprContext mapExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if (_la==LPAREN || ((((_la - 89)) & ~0x3f) == 0 && ((1L << (_la - 89)) & 7L) != 0)) {
				{
				setState(1302);
				mapEntry();
				setState(1308);
	...
	public final SetExprContext setExpr() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 632202144348373112L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 4063351L) != 0)) {
				{
				{
				setState(1361);
				listEntry();
	...
	public final LambdaExprContext lambdaExpr() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if (((((_la - 49)) & ~0x3f) == 0 && ((1L << (_la - 49)) & 1099511627785L) != 0)) {
					{
					setState(1400);
					lambdaDef();
					}
	...
	public final JsonArrayContext jsonArray() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 27262976L) != 0) || ((((_la - 70)) & ~0x3f) == 0 && ((1L << (_la - 70)) & 3538951L) != 0)) {
				{
				setState(1840);
				jsonValue();
				setState(1846);
	...
	public static final String _serializedATN =
		...
		"e\u0003e\u06a0\be\u0001f\u0001f\u0001f\u0005f\u06a5\bf\nf\ff\u06a8\tf"+
		"\u0001f\u0001f\u0005f\u06ac\bf\nf\ff\u06af\tf\u0001f\u0001f\u0001f\u0001"+
		"f\u0001f\u0001f\u0001f\u0001f\u0001f\u0003f\u06ba\bf\u0001g\u0003g\u06bd"+
		"\bg\u0001g\u0001g\u0003g\u06c1\bg\u0001h\u0001h\u0001h\u0001h\u0001h\u0001"+
		"h\u0001h\u0001h\u0001h\u0005h\u06cc\bh\nh\fh\u06cf\th\u0001h\u0001h\u0001"+
		"h\u0001h\u0003h\u06d5\bh\u0001i\u0001i\u0001i\u0001i\u0001i\u0003i\u06dc"+
		"\bi\u0001j\u0001j\u0001k\u0001k\u0001k\u0001k\u0001k\u0001k\u0001k\u0001"+
		"k\u0001k\u0001k\u0005k\u06ea\bk\nk\fk\u06ed\tk\u0001k\u0001k\u0005k\u06f1"+
		"\bk\nk\fk\u06f4\tk\u0001k\u0001k\u0003k\u06f8\bk\u0001l\u0001l\u0005l"+
		"\u06fc\bl\nl\fl\u06ff\tl\u0001l\u0001l\u0001l\u0001l\u0005l\u0705\bl\n"+
		"l\fl\u0708\tl\u0001l\u0003l\u070b\bl\u0003l\u070d\bl\u0001l\u0005l\u0710"+
		"\bl\nl\fl\u0713\tl\u0001l\u0001l\u0001m\u0001m\u0003m\u0719\bm\u0001m"+
		"\u0005m\u071c\bm\nm\fm\u071f\tm\u0001m\u0001m\u0005m\u0723\bm\nm\fm\u0726"+
		"\tm\u0001m\u0001m\u0001n\u0001n\u0005n\u072c\bn\nn\fn\u072f\tn\u0001n"+
		"\u0001n\u0001n\u0001n\u0005n\u0735\bn\nn\fn\u0738\tn\u0001n\u0003n\u073b"+
		"\bn\u0003n\u073d\bn\u0001n\u0005n\u0740\bn\nn\fn\u0743\tn\u0001n\u0001"+
